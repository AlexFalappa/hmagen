...
public class EOProductOptPanel extends javax.swing.JPanel {
    ...
    public void setEnabled(boolean flag) {
        chCloudCov.setEnabled(flag);
        chIllumAzim.setEnabled(flag);
        chIllumElev.setEnabled(flag);
        chSnowCov.setEnabled(flag);
        Utils.widgetsEnable(flag && chCloudCov.isSelected(), lCc1, lCc2, spCldCovFrom, spCldCovTo);
        Utils.widgetsEnable(flag && chIllumAzim.isSelected(), lIa1, lIa2, spIllAzimFrom, spIllAzimTo);
        Utils.widgetsEnable(flag && chIllumElev.isSelected(), lIe1, lIe2, spIllElevFrom, spIllElevTo);
        Utils.widgetsEnable(flag && chSnowCov.isSelected(), lSc1, lSc2, spSnwCovFrom, spSnwCovTo);
    }
    ...
    private void chCloudCovItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chCloudCovItemStateChanged
        Utils.widgetsEnable(chCloudCov.isSelected(), spCldCovFrom, spCldCovFrom,
    ...
    private void chSnowCovItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chSnowCovItemStateChanged
        Utils.widgetsEnable(chSnowCov.isSelected(), spSnwCovFrom, spSnwCovTo,
                lSc1, lSc2);
    ...
    private void chIllumElevItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chIllumElevItemStateChanged
        Utils.widgetsEnable(chIllumElev.isSelected(), spIllElevFrom, spIllElevTo,
                lIe1, lIe2);
    ...
    private void chIllumAzimItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chIllumAzimItemStateChanged
        Utils.widgetsEnable(chIllumAzim.isSelected(), spIllAzimFrom, spIllAzimTo,
                lIa1, lIa2);
