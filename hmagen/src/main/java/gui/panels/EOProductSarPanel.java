...
public class EOProductSarPanel extends javax.swing.JPanel {
    ...
    public void setEnabled(boolean flag) {
        chAntLook.setEnabled(flag);
        chMaxIncidAng.setEnabled(flag);
        chMinIncidAng.setEnabled(flag);
        chPolarzChans.setEnabled(flag);
        chPolarzModes.setEnabled(flag);
        bAntLookVals.setEnabled(flag && chAntLook.isSelected());
        bPlrzChVals.setEnabled(flag && chPolarzChans.isSelected());
        bPlrzMdVals.setEnabled(flag && chPolarzModes.isSelected());
        Utils.widgetsEnable(flag && chMinIncidAng.isSelected(), lMni1, lMni2, spMinIaFrom, spMinIaTo);
        Utils.widgetsEnable(flag && chMaxIncidAng.isSelected(), lMxi1, lMxi2, spMaxIaFrom, spMaxIaTo);
    }
